* Figure out stdin reading piecemeal
* Get the tokenizer ready for piecemeal tokenization
* Remove the negative patterns in the tokenizer table
* Think about a const McKeenan form grammar parser



Use clap, thiserror, and tokio, but not serde
